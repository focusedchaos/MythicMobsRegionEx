...
public class NotInRegionsCondition extends SkillCondition implements ILocationCondition {
    private String regionListing;
    public NotInRegionsCondition(String line, MythicLineConfig mythicLineConfig){
        super(line);
    ...
    public boolean check(AbstractLocation targetLocation) {
        try {
            ...
            Main.logger.logDebug(String.format("NotInRegionExCondition check fired for region \"%s\".  Result: %s", this.regionListing, inRegionExResult), 3);
